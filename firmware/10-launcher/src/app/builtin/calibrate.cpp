...
// Touch now uses Phase 0 TFT_eSPI built-in mapping with factory cal {275, 3620, 264, 3532, 4}.
// calData[4]=4: bit0 no swap + bit1 invert Y — corrects observed axis mapping.
